...
import { validateRegister } from '../middlewares/userValidatos.js'
...
authRouter.post('/register', passport.authenticate('register'), validateRegister, userController.register)
